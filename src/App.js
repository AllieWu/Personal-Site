...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      resumeData: {
        main: { name: "Allison Wu", namecapped: "ALLISON WU", subtitle: "", bio: "Welcome to my personal site! I'm a junior Computer Science major at the University of Florida and some of my hobbies include building programs, tinkering, discovering music, and doodling :)", phone: "(916) 952-3707", email: "allisonwu2000@gmail.com", resume: "https://drive.google.com/file/d/1lNj-JfWkp4dxlt36tOLBaG-3YyS-ddxv/view?usp=sharing" },
        resume: {
          education: [
          ...
          work: [
            { imgname: "tesla-logo", company: "Tesla", title: "Web Development Intern", years: "May 2020 - August 2020", description: ["Full stack web development in the outbound logistics team of the IT Applications Engineering group.", "Completed 40+ bug fixes/features on a highly complex homegrown set of applications managing all national/international vehicle transport.", "Worked closely with other developers, QA, and management to finish weekly releases and handle production bugs.", "Adept in exceptionally fast-paced software development using Scrum/Agile methodologies"], skills: ["C#", "Javascript", "HTML/CSS", "GIT", "SQL", "Full Stack Web Development", "Angular", "React", "Svelte", ".Net", "Asp.Net", "Dapper ORM", "PetaPoco ORM", "Scrum/Agile Methodologies"]},
          ...
          involvement: [
            { imgname: "magician-logo", name: "Magician", position1 : { title: "Project Lead, Recruiter, Developer", years: "August 2018 - Present", description: ["Project lead for a select group of students passionate about all aspects of video game development, including but not limited to programming, game design, and art. Magician was developed using Unity (C#).", "Programmed the user interfaces, inventory/crafting/quest/job system, and resource loading."], skills: ["C#", "Leadership", "Recruiting", "UI Development", "Project Management"]} },
            { imgname: "swamphacks-logo", name: "SwampHacks", position1: { title: "Logistics Director", years: "March 2020 - Present", description: ["Organized annual 36-hour hackathon for 818 students with 18+ sponsors including companies such as Microsoft, Google, and J.P. Morgan.", "Oversaw all logistics operations of the hospitality, travel, food, activities, event, and sustainability coordination groups.", "Responsible for scheduling and budgeting all for the above categories as well as overall succcess of the event."], skills: ["Event Management", "Interpersonal Skills", "People Management"]}, position2:  { imgname: "swamphacks-logo", name: "SwampHacks", title: "Activities Coordinator", years: "September 2019 - February 2019", description: ["Planned and managed 20 activities throughout the 36-hour period."], skills: ["Event Management", "Interpersonal Skills", "Creativity"] }},
            { imgname: "swe-logo", name: "Society of Women Engineers", position2: { title: "Member", years: "August 2019 - Present", description: ["SWE is the world's largest advocate for women in STEAM.", "UF's chapter helps individuals reach their full potential by providing opportunities for career development, relationship building, and by promoting the presence of women."]}, position1: { title: "Evening with Industry Chair", years: "April 2020 - Present", description: ["Evening with Industry (EWI) is a career fair for organization and community members to network with companies.", "EWI chair responsibilities include recruiting sponsors, handling budgets, ensuring the success of the event, and all related logistics."], skills: ["Event Management", "Professional Networking"] } },
            { imgname: "ufkb-logo", name: "UF Kickboxing Club", position1: { title: "Member", years: "September 2018 - Present", description: ["Proud member of UFKB, meeting four times a week to hone individuals' skills in sparring with an emphasis in kickboxing among other martial arts."], skills: ["Kickboxing"]} },
          ],
        },
        projects: {
          mainprojects: [
