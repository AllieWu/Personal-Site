  ...
  render() {
    if (this.props.data !== undefined) {
            ...
            <h3>
              <a href="http://www.ufl.edu/">
                <img
                  ...
                  src={education.imgname === "uflogo" ? uflogo : undefined}
                  alt={education.imgname + "Image"}
                />
              </a>
              {"     " + education.school}
            </h3>
      ...
      var work = this.props.data.work.map(function (work) {
        var useLogo =
          work.imgname === "intel-logo"
            ? intellogo
            : work.imgname === "vector-logo"
            ? vectorlogo
            : work.imgname === "tesla-logo"
            ? teslalogo
            : work.imgname === "microsoft-logo"
            ? microsoftlogo
            : undefined;
        var useLink =
          work.imgname === "intel-logo"
            ...
            : undefined;
        var skills =
          work.skills !== undefined
            ? work.skills.map(function (skill) {
                return (
                  <span key={work.title + " skills"} className="skill">
                    {skill}
                  </span>
                );
              })
          ...
          <div key={work.company} className="resume item">
            <div className="parentInfo">
              <h3 className="companyName">
                <a href={useLink}>
                  <img
                    className={work.imgname}
                    src={useLogo}
                    alt={work.imgname + "Image"}
                  />
                </a>
                {work.company}
              </h3>
      ...
      var involvement = this.props.data.involvement.map(function (involvement) {
        var useLogo =
          involvement.imgname === "swamphacks-logo"
            ? swamphackslogo
            : involvement.imgname === "magician-logo"
            ? magicianlogo
            : involvement.imgname === "swe-logo"
            ? swelogo
            : involvement.imgname === "ufkb-logo"
            ? ufkblogo
            : undefined;
        var useLink =
          involvement.imgname === "swamphacks-logo"
            ? "https://2020.swamphacks.com/"
            : involvement.imgname === "swe-logo"
            ? "http://www.ufswe.com/"
            : involvement.imgname === "ufkb-logo"
            ? "https://www.facebook.com/groups/533348426850757/"
            : undefined;

        if (involvement.position1 !== undefined) {
          var skills1 =
            involvement.position1.skills !== undefined
              ? involvement.position1.skills.map(function (skill) {
                  return (
                    <span key={involvement.title + " skills"} className="skill">
                      {skill}
                    </span>
                  );
                })
              : undefined;
          var description1 =
            involvement.position1.description !== undefined
              ? involvement.position1.description.map(function (desc) {
                  return (
                    <p key={involvement.position1.title + " description"}>
                      {desc}
                    </p>
                  );
                })
        ...
        if (involvement.position2 !== undefined) {
          var skills2 =
            involvement.position2.skills !== undefined
              ? involvement.position2.skills.map(function (skill) {
                  return (
                    <span key={involvement.title + " skills"} className="skill">
                      {skill}
                    </span>
              ...
              : undefined;
          var description2 =
            involvement.position2.description !== undefined
              ? involvement.position2.description.map(function (desc) {
                  return (
                    <p
                      key={involvement.position2.title + " description"}
          ...
          var position2 = (
            <div className="secondaryPosition">
              <div className="parentInfo">
    ...
    return (
      <section id="resume">
        ...
        <div className="row involvement">
          ...
          <div className="nine columns main-col">{involvement}</div>
        </div>
      </section>
    );
  }
