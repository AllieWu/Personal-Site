...
import pjangImage from "./../assets/pjang.png";
...
class Portfolio extends Component {
  render() {
    if (this.props.data !== undefined) {
      ...
      var projectsFormatted = this.props.data.mainprojects.map(function (
        project
      ) {
        var projectImage =
          project.image === "ncs-image"
            ? ncsImage
            : project.image === "magician-image"
            ? magicianImage
            : project.image === "website-image"
            ? websiteImage
            : project.image === "pjang-image"
            ? pjangImage
            : lakeImage;
        return (
    ...
    return (
      <section id="projects">
        <div className="row portfolio">
          ...
          <div className="nine columns main-col">{projectsFormatted}</div>
        </div>
        ...
        <div className="row portfolio">
          ...
          <div className="nine columns main-col">{miniFormatted}</div>
        </div>
      </section>
    );
  }
